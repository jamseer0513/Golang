...
main.go
>> 128 line: 회원가입
- 공백확인, 사용자ID 중복확인를 고려한 조건문 추가

>> 222 line: 회원탈퇴
- 세션으로 접근하는것을 뒤늦게 알아 password만으로 회원탈퇴를 구현
- 회원탈퇴시 세션을 자동으로 삭제하고 퀴리문을 보완할 필요가 있어보임.

>> 272 line: 입금
- 퀴리에 balance 업데이트 후에, 세션도 변경
>> 311 line: 출금
...
>> 509 line: 글 상세-상세 응답 and 게시글 목록-선택한 게시글

>> 542 line: 글 상세-변경요청-수정

>> 600 line: 글 상세-변경요청-삭제

핸들러 분리
- func main의 부피를 줄이기 위해 auth, posts를 따로 분리할 것같다.